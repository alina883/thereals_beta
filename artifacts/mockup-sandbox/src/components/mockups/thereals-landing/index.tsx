...
function useGlobalStyles() {
  useEffect(() => {
    ...
    return () => { s.remove(); };
  }, [editorial400, editorial600, editorial700, editorial800, editorial400i, editorial700i, editorial800i]);
}
  ...
  return (
    <nav style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 36 }}>
        <button className="tr-nav-link" onClick={() => setPage('creator')}>Creators</button>
        <button className="tr-nav-link" onClick={() => setPage('brand')}>Brands</button>
        <button className="tr-nav-link" style={{ color: C.muted }}>About</button>
        <button
      ...
      <div style={{
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
            <button className="tr-btn-primary" onClick={() => setPage('creator')}>
              Join as a Creator →
            </button>
            <button className="tr-btn-ghost" onClick={() => setPage('brand')}>
              For Brands
            </button>
          </div>
        </motion.div>
...
function ManifestoSection({ setPage }: { setPage: (p: Page) => void }) {
  return (
    <section style={{
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
          ...
          <div style={{ width: '100%' }}>
            <div className="tr-film-frame">
              ...
              <div style={{
                ...
                padding: '14px 16px',
                background: `rgba(${parseInt(C.red.slice(1,3),16)},${parseInt(C.red.slice(3,5),16)},${parseInt(C.red.slice(5,7),16)},0.85)`,
                display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                zIndex: 3,
              }}>
                ...
                <span style={{ fontFamily: mono, fontSize: 9, color: 'rgba(255,255,255,0.6)' }}>
                  00:00
                </span>
              </div>
            </div>
...
const features = [
  {
    ...
    body: 'We connect Creators with brands whose values align with yours — no cold outreach, no race to the bottom on rates. Every brand on The Reals has been vetted for authentic partnership potential.',
    tag: 'For Creators',
  },
  {
    num: '02',
    title: 'Transparent Deal Flow',
    body: 'Clear briefs, fair rates, honest timelines. Every campaign on The Reals comes with full transparency on deliverables, creative freedom, and commercial terms before you commit.',
    tag: 'Deal Structure',
  },
  {
    num: '03',
    title: 'Audience-First Analytics',
    body: 'Track what your audience actually responds to — engagement quality over vanity metrics. Help brands understand the difference between reach and real influence.',
    tag: 'Intelligence',
  },
  {
    num: '04',
    title: 'A Community of Reals',
    body: 'Access a private network of Creators who take their craft seriously. Peer review, shared learnings, and a collective voice strong enough to set new industry standards.',
    tag: 'Community',
  },
];
...
function JoinSection({ setPage }: { setPage: (p: Page) => void }) {
  return (
    <section style={{
      display: 'grid',
      gridTemplateColumns: '1fr 1fr',
      ...
      <InView>
        ...
        >
          <div style={{
            ...
            fontFamily: serif, fontWeight: 800,
            fontSize: 120, color: 'rgba(26,24,20,0.045)',
            lineHeight: 1, pointerEvents: 'none', userSelect: 'none',
          }}>01</div>

          <div className="tr-section-tag" style={{ marginBottom: 20 }}>
            <span style={{ color: C.red, fontFamily: mono, fontSize: 8, letterSpacing: '0.22em', textTransform: 'uppercase' }}>
              ● Now Open
            </span>
          </div>
          <h2 style={{
            ...
            I'm a<br />
            <em style={{ fontStyle: 'italic' }}>Creator.</em>
          </h2>
          <p style={{
            fontFamily: serif,
            fontStyle: 'italic',
          ...
          <ul style={{ listStyle: 'none', marginBottom: 40 }}>
            {[
              'Curated brand matching, no cold outreach',
              'Transparent rates and creative freedom',
              'Community of Creators who get it',
            ].map(item => (
              <li key={item} style={{
                fontFamily: mono,
                fontSize: 11,
      ...
      <InView delay={0.12}>
        ...
        >
          <div style={{
            position: 'absolute', top: -16, right: 24,
            fontFamily: serif, fontWeight: 800,
            fontSize: 120, color: 'rgba(26,24,20,0.04)',
            lineHeight: 1, pointerEvents: 'none', userSelect: 'none',
          }}>02</div>
          ...
          <h2 style={{
            ...
            I'm a<br />
            <em style={{ fontStyle: 'italic' }}>Brand.</em>
          </h2>
          <p style={{
            fontFamily: serif,
            fontStyle: 'italic',
          ...
          <ul style={{ listStyle: 'none', marginBottom: 40 }}>
            {[
              'Access to verified authentic Creators',
              'Campaign briefs built around creative integrity',
...
function Footer({ setPage }: { setPage: (p: Page) => void }) {
  return (
    <footer style={{
      ...
      <button onClick={() => setPage('home')} style={{ background: 'none', border: 'none', cursor: 'none' }}>
...
function LandingPage({ setPage }: { setPage: (p: Page) => void }) {
  return (
    ...
    >
      ...
      <ManifestoSection setPage={setPage} />
      <MovementSection />
...
function CreatorJoinPage({ setPage }: { setPage: (p: Page) => void }) {
  const [submitted, setSubmitted] = useState(false);
  const [form, setForm] = useState({
    name: '', email: '', handle: '', category: '',
  });
        ...
        {!submitted ? (
          <>
            <InView>
              ...
              <h1 style={{
                ...
                Join as a<br />
                <em style={{ fontStyle: 'italic', color: C.red }}>Creator.</em>
              </h1>
            </InView>
                ...
                <div>
                  {[
                    ...
                    <div key={step.n} style={{ display: 'flex', gap: 20, marginBottom: 28 }}>
                      <div style={{
                        fontFamily: serif, fontWeight: 800, fontSize: 13,
                        color: C.red, paddingTop: 2, flexShrink: 0,
                      }}>{step.n}</div>
                      <div>
          ...
          >
            ...
            <h2 style={{
              ...
              You're in<br />
              <em style={{ fontStyle: 'italic', color: C.red }}>the queue.</em>
            </h2>
            <p style={{
              fontFamily: serif,
              fontStyle: 'italic',
            ...
            <button className="tr-btn-ghost" onClick={() => setPage('home')}>
              ← Back to The Reals
            </button>
          </motion.div>
        )}
...
function BrandJoinPage({ setPage }: { setPage: (p: Page) => void }) {
  const [submitted, setSubmitted] = useState(false);
  const [form, setForm] = useState({
    company: '', contact: '', email: '', useCase: '',
  });
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -10 }}
      transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }}
      style={{ minHeight: '100vh', background: C.ink }}
    >
      <div style={{
        maxWidth: 880,
        margin: '0 auto',
        ...
        <button
          style={{
            ...
            textTransform: 'uppercase', color: 'rgba(246,245,241,0.4)',
            background: 'none', border: 'none', cursor: 'none',
            marginBottom: 52, display: 'flex', alignItems: 'center', gap: 8,
            transition: 'color 0.2s',
          }}
          onMouseOver={e => (e.currentTarget.style.color = C.white)}
          onMouseOut={e => (e.currentTarget.style.color = 'rgba(246,245,241,0.4)')}
          onClick={() => setPage('home')}
        >
          ← Back to The Reals
        </button>
        ...
        {!submitted ? (
          <>
            ...
            >
              <div style={{
                ...
                textTransform: 'uppercase', color: 'rgba(246,245,241,0.45)',
              ...
              <h1 style={{
                ...
                Partner<br />
                <em style={{ fontStyle: 'italic', color: C.red }}>With Us.</em>
              </h1>
            </motion.div>
            ...
            >
              <div style={{
                ...
                marginBottom: 72,
                paddingBottom: 72,
                borderBottom: '1px solid rgba(246,245,241,0.1)',
              }}>
                <div>
                  <p style={{
                    fontFamily: serif,
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 48px' }}>
                  <div>
                    <label style={{
                      ...
                      color: 'rgba(246,245,241,0.35)', marginBottom: 4, marginTop: 28,
                    }}>Company Name</label>
                    <input
                      style={{
                        display: 'block', width: '100%', fontFamily: mono,
                        fontSize: 11, background: 'transparent',
                        border: 'none', borderBottom: '1px solid rgba(246,245,241,0.15)',
                  ...
                  <div>
                    ...
                    <select
                      style={{
                        ...
                        border: 'none', borderBottom: '1px solid rgba(246,245,241,0.15)',
                        padding: '14px 0', color: C.white, outline: 'none',
                        appearance: 'none', cursor: 'none', letterSpacing: '0.04em',
                      }}
                      required
                      value={form.useCase}
          ...
          >
            ...
            <h2 style={{
              ...
              We'll be in<br />
              <em style={{ fontStyle: 'italic', color: C.red }}>touch.</em>
            </h2>
            <p style={{
              fontFamily: serif,
              fontStyle: 'italic',
...
export default function TherealsLanding() {
  ...
  useEffect(() => {
    const root = document.querySelector('.tr-root') as HTMLElement;
    if (root) {
      root.scrollTop = 0;
    }
    window.scrollTo(0, 0);
  ...
  const navBg = page === 'brand' ? 'transparent' : C.paper;
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        height: 80,
        background: page === 'brand' ? C.ink : C.paper,
        zIndex: 490,
        borderBottom: page !== 'brand' ? `1px solid transparent` : 'none',
      ...
      <AnimatePresence mode="wait">
        ...
        {page === 'creator' && <CreatorJoinPage key="creator" setPage={setPage} />}
        {page === 'brand' && <BrandJoinPage key="brand" setPage={setPage} />}
      </AnimatePresence>
    </div>
  );
}
